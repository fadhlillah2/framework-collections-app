mvn clean package
docker build -f src/main/Docker/Dockerfile.jvm -t portfolio-image .
...
You can then execute your native executable with: `./target/portfolio-service-1.0-SNAPSHOT-runner`
